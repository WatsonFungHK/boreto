...
import { columns } from "../../../constants/designation";
...
const Overview = () => {
  ...
  const {
    ...
    error,
    isLoading,
  } = useItems("/api/designation/all", { pageNumber, pageSize, keyword });
  const { t } = useTranslation();

  const goToCreate = () => {
    router.push("/company/designation/new");
  };

  return (
    <Stack spacing={2}>
      <Typography>{t("staff-designation")}</Typography>
      <Stack
